...
- Write your summary paragraph first. Then pick exactly ONE phrase already in that paragraph — the single clearest answer to the user's question — and wrap it with <mark> tags. Do NOT add new sentences. The marked phrase must: (1) be self-contained and understandable without surrounding context — a reader must be able to understand it with the rest of the paragraph hidden, (2) state a clear direction using plain words (e.g. "X increases Y" or "X had no effect on Y"), (3) come directly from study findings, never from your own inferences, and (4) be specific — include a concrete detail such as the type of intervention, the population, a dose, or a magnitude rather than a vague generic statement like "X improves Y". NEVER mark a bare number, unit, or measurement on its own (e.g. "2.4 mm Hg") — the mark must always name what was measured and in which direction it changed, not just the figure. NEVER mark your own concluding or summary sentence (e.g. a final "Exercise benefits memory"-style wrap-up) — mark a sentence that reports one specific study's actual result instead.
